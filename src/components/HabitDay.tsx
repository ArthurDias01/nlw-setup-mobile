...
export function HabitDay({ date, amountCompleted = 0, amountOfHabits = 0, ...rest }: Props) {
  ...
  const amountAccomplishedPercentage = amountOfHabits > 0 && amountCompleted > 0 ? generateProgressPercentage({ total: amountCompleted, completed: amountOfHabits }) : 0;
  ...
  return (
    <TouchableOpacity
      ...
      className={clsx("rounded-lg border-2  m-1", {
        ...
        'border-4 border-green-400': isCurrentDay,
      })}
